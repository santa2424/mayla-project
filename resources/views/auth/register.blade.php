  ...
  <div class="card shadow border-0 w-100" style="max-width: 600px; min-width: 400px;">
    ...
    <div class="card-body p-4">
      ...
      <div class="d-flex justify-content-center mb-4">
        <a href="{{ route('login') }}" class="btn btn-light btn-sm border rounded-0">Sign In</a>
        <a href="{{ route('register') }}" class="btn btn-dark btn-sm rounded-0">Sign Up</a>
      </div>
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <button type="submit" class="btn btn-dark btn-block mt-4">Sign Up</button>
      </form>
    </div>
